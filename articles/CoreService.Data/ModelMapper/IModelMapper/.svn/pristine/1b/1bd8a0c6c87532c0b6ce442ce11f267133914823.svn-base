...
## **IModelMapper.Scalar&#60;TModel>(string expression, params object[] parameters) Method**
...
根据TModel中定义的检索条件来检索指定的SQL Expression的第一行的第一列数据。

Retrieves data of the first column in the first row for the specified SQL expression according to the criteria specified in a TModel class.
