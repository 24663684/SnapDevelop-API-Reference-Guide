...
如果需要继续利用进行其他数据操作，请重新使用IModelMapper.TrackCreate&#60;TModel>(TModel model)等 Method进行追踪。

To continue using ModelMapper for other data operations, use IModelMapperTrackCreate&#60;TModel>(TModel model) etc. to track the changes again.
